...
void setup() {
    ...
    pinMode(STBY, OUTPUT);
    digitalWrite(STBY, HIGH);  // driver aan
...
void loop() {
    ...
    BTSerial.print("Power left: ");
    BTSerial.println(powerLeft);

    BTSerial.print("Power Right: ");
    BTSerial.println(powerRight);
